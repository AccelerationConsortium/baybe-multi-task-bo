...
Welcome to `baybe-multi-task-bo` contributor's guide.
...
If you experience bugs or general issues with `baybe-multi-task-bo`, please have a look
...
You can help improve `baybe-multi-task-bo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`baybe-multi-task-bo` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `baybe-multi-task-bo`'s files. While this mechanism can
...
```
conda create -n baybe-multi-task-bo python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/baybe-multi-task-bo.git
   cd baybe-multi-task-bo
   ```
...
5. Install [pre-commit]:
   ...
   `baybe-multi-task-bo` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/baybe-multi-task-bo
[issue tracker]: https://github.com/<USERNAME>/baybe-multi-task-bo/issues
